...
var itemAnim = Object(_angular_animations__WEBPACK_IMPORTED_MODULE_0__["trigger"])('item', [
...
var CopyTaskComponent = /** @class */ (function () {
    function CopyTaskComponent(dialogRef, data, fb) {
    ...
    CopyTaskComponent.prototype.onSubmit = function (ev, _a) {
    ...
    CopyTaskComponent.ctorParameters = function () { return [
...
var NewTaskListComponent = /** @class */ (function () {
    function NewTaskListComponent(data, dialogRef, fb) {
        this.data = data;
        this.dialogRef = dialogRef;
        this.fb = fb;
        this.title = "";
    ...
    NewTaskListComponent.prototype.onSubmit = function (_a) {
        var value = _a.value, valid = _a.valid;
        if (!valid) {
            return;
        }
    ...
    NewTaskListComponent.ctorParameters = function () { return [
...
var NewTaskComponent = /** @class */ (function () {
    function NewTaskComponent(data, fb, dialogRef) {
        this.data = data;
        this.fb = fb;
        this.dialogRef = dialogRef;
        this.title = "";
    ...
    NewTaskComponent.prototype.ngOnInit = function () {
        if (!this.data.task) {
            ...
            this.form = this.fb.group({
                ...
                followers: [this.data.task.participants ? tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](this.data.task.participants) : []],
    ...
    NewTaskComponent.prototype.onSubmit = function (ev, _a) {
        var value = _a.value, valid = _a.valid;
        ev.preventDefault();
        if (!valid) {
            return;
        }
        this.dialogRef.close(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, value, { ownerId: value.owner.length > 0 ? value.owner[0].id : null, participantIds: value.followers.map(function (f) { return f.id; }) }));
    };
...
var QuickTaskComponent = /** @class */ (function () {
    ...
    QuickTaskComponent.prototype.onSubmit = function (_a, ev) {
        var value = _a.value, valid = _a.valid;
        ev.preventDefault();
...
var TaskHomeComponent = /** @class */ (function () {
    function TaskHomeComponent(dialog, store$, route) {
        this.dialog = dialog;
        this.store$ = store$;
        this.route = route;
        ...
        // );
        this.projectId$ = this.route.paramMap.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["map"])(function (p) { return p.get('id'); }));
    ...
    TaskHomeComponent.prototype.launchNewTaskDialog = function (list) {
        var _this = this;
        var user$ = this.store$.pipe(Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_2__["select"])(_reducers__WEBPACK_IMPORTED_MODULE_9__["getAuthState"]));
        user$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["map"])(function (auth) { return auth.user; })).subscribe(function (user) {
            var dialogRef = _this.dialog.open(_new_task_new_task_component__WEBPACK_IMPORTED_MODULE_4__["NewTaskComponent"], { data: { owner: user } });
            dialogRef.afterClosed().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["filter"])(function (n) { return n; })).subscribe(function (val) {
                _this.store$.dispatch(_actions_task_action__WEBPACK_IMPORTED_MODULE_13__["add"]({ payload: tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, val, { taskListId: list.id, completed: false, createDate: new Date() }) }));
            });
        });
    };
    TaskHomeComponent.prototype.launchCopyTaskDialog = function (list) {
        var _this = this;
        var list$ = this.lists$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["map"])(function (l) { return l.filter(function (n) { return n.id !== list.id; }); }));
        var dialogRef = this.dialog.open(_copy_task_copy_task_component__WEBPACK_IMPORTED_MODULE_5__["CopyTaskComponent"], { data: { srcListId: list.id, lists: list$ } });
        dialogRef.afterClosed().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["filter"])(function (n) { return n; })).subscribe(function (val) {
            _this.store$.dispatch(_actions_task_action__WEBPACK_IMPORTED_MODULE_13__["moveAll"]({ payload: val }));
        });
    };
    TaskHomeComponent.prototype.launchUpdateTaskDialog = function (task) {
        var _this = this;
        var dialogRef = this.dialog.open(_new_task_new_task_component__WEBPACK_IMPORTED_MODULE_4__["NewTaskComponent"], { data: {
                task: task
            } });
        dialogRef.afterClosed().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["filter"])(function (n) { return n; })).subscribe(function (val) {
            _this.store$.dispatch(_actions_task_action__WEBPACK_IMPORTED_MODULE_13__["update"]({ payload: tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, task, val) }));
        });
    };
    TaskHomeComponent.prototype.launchConfirmDialog = function (list) {
        var _this = this;
        var dialogRef = this.dialog.open(_shared_confirm_dialog_confirm_dialog_component__WEBPACK_IMPORTED_MODULE_6__["ConfirmDialogComponent"], { data: {
                title: "删除列表:",
                content: "您确认删除该列表吗?"
            } });
        dialogRef.afterClosed().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["filter"])(function (n) { return n; })).subscribe(function (result) {
            _this.store$.dispatch(_actions_task_list_action__WEBPACK_IMPORTED_MODULE_12__["deleteTaskList"]({ payload: list }));
        });
    };
    TaskHomeComponent.prototype.launchEditListDialog = function (list) {
        var _this = this;
        var dialogRef = this.dialog.open(_new_task_list_new_task_list_component__WEBPACK_IMPORTED_MODULE_7__["NewTaskListComponent"], { data: {
                title: "更改列表名称:",
                name: list.name
            } });
        dialogRef.afterClosed().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["take"])(1)).subscribe(function (result) {
            _this.store$.dispatch(_actions_task_list_action__WEBPACK_IMPORTED_MODULE_12__["update"]({ payload: tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, result, { id: list.id }) }));
        });
    };
    TaskHomeComponent.prototype.launchNewListDialog = function (ev) {
        var _this = this;
        var dialogRef = this.dialog.open(_new_task_list_new_task_list_component__WEBPACK_IMPORTED_MODULE_7__["NewTaskListComponent"], { data: {
                title: "新建列表:"
            } });
        dialogRef.afterClosed().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["withLatestFrom"])(this.projectId$, function (val, projectId) { return (tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, val, { projectId: projectId })); })).subscribe(function (result) {
            _this.store$.dispatch(_actions_task_list_action__WEBPACK_IMPORTED_MODULE_12__["add"]({ payload: result }));
        });
    };
    TaskHomeComponent.prototype.handleMove = function (srcData, list) {
        switch (srcData.tag) {
            case 'task-item':
            ...
            case 'task-list':
                ...
                var srcList = srcData.data;
                var tempOrder = srcList.order;
    ...
    TaskHomeComponent.prototype.handleQuickTask = function (desc, list) {
        var _this = this;
        var user$ = this.store$.pipe(Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_2__["select"])(_reducers__WEBPACK_IMPORTED_MODULE_9__["getAuthState"]));
        user$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["map"])(function (auth) { return auth.user; })).subscribe(function (user) {
            _this.store$.dispatch(_actions_task_action__WEBPACK_IMPORTED_MODULE_13__["add"]({ payload: {
                    desc: desc,
                    priority: 3,
                    taskListId: list.id,
                    ownerId: user.id,
    ...
    TaskHomeComponent.ctorParameters = function () { return [
...
//# sourceMappingURL=task-es5.js.map