...
const cardAnim = Object(_angular_animations__WEBPACK_IMPORTED_MODULE_0__["trigger"])('card', [
...
const listAnimation = Object(_angular_animations__WEBPACK_IMPORTED_MODULE_0__["trigger"])('listAnim', [
...
let ProjectListComponent = class ProjectListComponent {
    constructor(dialog, cd, store$) {
        ...
        this.listAnim$ = this.projects$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["map"])(p => p.length));
    }
    ngOnInit() {
    }
    ngOnDestroy() {
    ...
    openNewProjectDialog() {
        ...
        const dialogRef = this.dialog.open(_new_project_new_project_component__WEBPACK_IMPORTED_MODULE_5__["NewProjectComponent"], { data: {
        ...
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["filter"])(n => n), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["map"])(val => (Object.assign({}, val, { coverImg: this.buildImgSrc(val.coverImg) })))).subscribe(p => {
            this.store$.dispatch(_actions__WEBPACK_IMPORTED_MODULE_12__["add"]({ payload: p }));
        });
    }
    launchInviteDialog(project) {
        this.store$.pipe(Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_2__["select"])(_reducers__WEBPACK_IMPORTED_MODULE_3__["getProjectUsers"](project.id))).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["map"])(users => this.dialog.open(_invite_invite_component__WEBPACK_IMPORTED_MODULE_6__["InviteComponent"], { data: { members: users } })), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["switchMap"])(dialogRef => dialogRef.afterClosed().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["filter"])(n => n), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["map"])(val => this.store$.dispatch(_actions__WEBPACK_IMPORTED_MODULE_12__["invite"]({ payload: { projectId: project.id, members: val } }))))));
    }
    launchUpdateDialog(project) {
        ...
        dialogRef.afterClosed().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["filter"])(n => n), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["map"])(val => (Object.assign({}, val, { id: project.id, coverImg: this.buildImgSrc(val.coverImg) })))).subscribe(p => {
            this.store$.dispatch(_actions__WEBPACK_IMPORTED_MODULE_12__["update"]({ payload: p }));
        });
    }
    launchConfirmDialog(project) {
        const dialogRef = this.dialog.open(_shared_confirm_dialog_confirm_dialog_component__WEBPACK_IMPORTED_MODULE_7__["ConfirmDialogComponent"], { data: {
                title: "删除项目:",
                content: "您确认删除该项目吗?"
            } });
        ...
        // });
        dialogRef.afterClosed().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["filter"])(n => n)).subscribe(_ => {
            this.store$.dispatch(_actions__WEBPACK_IMPORTED_MODULE_12__["deleteProject"]({ payload: project }));
        });
    }
    getThumbnails() {
        return lodash__WEBPACK_IMPORTED_MODULE_10__["range"](0, 39).map(i => `/assets/img/covers/${i}_tn.jpg`);
    }
    buildImgSrc(img) {
...
//# sourceMappingURL=project-es2015.js.map